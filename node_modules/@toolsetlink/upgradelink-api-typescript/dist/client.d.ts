...
export declare class AppStatisticsInfoRequest extends $tea.Model {
    appKey: string;
    static names(): {
        [key: string]: string;
    };
...
export declare class DownloadCount7DayInfo extends $tea.Model {
    timeData: string;
    data: number;
    static names(): {
        [key: string]: string;
...
export declare class AppGetStrategyCount7DayInfo extends $tea.Model {
    timeData: string;
    data: number;
    static names(): {
        [key: string]: string;
...
export declare class AppUpgradeCount7DayInfo extends $tea.Model {
    timeData: string;
    data: number;
    static names(): {
        [key: string]: string;
...
export declare class AppStartCount7DayInfo extends $tea.Model {
    timeData: string;
    data: number;
    static names(): {
        [key: string]: string;
...
export declare class AppStatisticsInfoDataResponse extends $tea.Model {
...
export declare class AppStatisticsInfoResponse extends $tea.Model {
    code: number;
    msg: string;
    traceId: string;
...
export default class Client {
    ...
    AppStatisticsInfo(request: AppStatisticsInfoRequest): Promise<AppStatisticsInfoResponse>;
