...
exports.AppReportRequestEventData = exports.AppStatisticsInfoResponse = exports.AppStatisticsInfoDataResponse = exports.AppStartCount7DayInfo = exports.AppUpgradeCount7DayInfo = exports.AppGetStrategyCount7DayInfo = exports.DownloadCount7DayInfo = exports.AppStatisticsInfoRequest = exports.AppReportResponse = void 0;
...
class AppStatisticsInfoRequest extends $tea.Model {
    static names() {
        return {
            appKey: 'appKey',
        };
...
exports.AppStatisticsInfoRequest = AppStatisticsInfoRequest;
class DownloadCount7DayInfo extends $tea.Model {
    static names() {
        return {
            timeData: 'timeData',
            data: 'data',
...
exports.DownloadCount7DayInfo = DownloadCount7DayInfo;
class AppGetStrategyCount7DayInfo extends $tea.Model {
    static names() {
        return {
            timeData: 'timeData',
            data: 'data',
...
exports.AppGetStrategyCount7DayInfo = AppGetStrategyCount7DayInfo;
class AppUpgradeCount7DayInfo extends $tea.Model {
    static names() {
        return {
            timeData: 'timeData',
            data: 'data',
...
exports.AppUpgradeCount7DayInfo = AppUpgradeCount7DayInfo;
class AppStartCount7DayInfo extends $tea.Model {
    static names() {
        return {
            timeData: 'timeData',
            data: 'data',
...
exports.AppStartCount7DayInfo = AppStartCount7DayInfo;
class AppStatisticsInfoDataResponse extends $tea.Model {
    static names() {
        return {
...
exports.AppStatisticsInfoDataResponse = AppStatisticsInfoDataResponse;
class AppStatisticsInfoResponse extends $tea.Model {
    static names() {
        return {
            code: 'code',
            msg: 'msg',
...
exports.AppStatisticsInfoResponse = AppStatisticsInfoResponse;
...
class Client {
    ...
    async AppStatisticsInfo(request) {
        let _runtime = {
            timeout: 10000,
            // 10s 的过期时间
        };
        ...
        while ($tea.allowRetry(_runtime['retry'], _retryTimes, _now)) {
            ...
            try {
                ...
                return $tea.cast(Object.assign({}, result), new AppStatisticsInfoResponse({}));
            }
            catch (ex) {
                if ($tea.isRetryable(ex)) {
                    continue;
